...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        n_inner_c = (planes-inplanes)//4
        self.relu = nn.ReLU(inplace=True)
        self.conv1 = conv3x3(inplanes+n_inner_c*1, inplanes+n_inner_c*2, stride)
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = conv3x3(inplanes+n_inner_c*2, inplanes+n_inner_c*3)
